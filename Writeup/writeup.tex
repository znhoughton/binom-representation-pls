...
it shifts the phrasal one. That the phrasal representation comes to
carry ordering information is not especially surprising, since attention
is what allows a representation of the pair to be built at all. That the
\emph{lexical} representations shift is the more interesting result, and
it parallels evidence from human processing that the internal
representations of a stored multi-word phrase are themselves altered by
