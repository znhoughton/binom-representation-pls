...
Usage:
    python Scripts/supplementary/per_word_preference.py
    python Scripts/supplementary/per_word_preference.py --models znhoughton_opt-babylm-125m-20eps-seed964
    python Scripts/supplementary/per_word_preference.py --vectors glove-wiki-gigaword-300
    python Scripts/supplementary/per_word_preference.py --skip-vectors
"""
import argparse
import re
import sys
