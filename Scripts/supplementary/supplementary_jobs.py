...
Usage:
    python Scripts/supplementary/supplementary_jobs.py
    python Scripts/supplementary/supplementary_jobs.py --only babylm pythia
    python Scripts/supplementary/supplementary_jobs.py --final-only
"""
import argparse
import csv
import re
