...
Usage:
    python Scripts/pipeline/run_scale_models.py [--models pythia gpt2 olmo llama]
                                      [--gpu 0]
                                      [--embeddings-dir /path]
                                      [--skip-large]
                                      [--skip-controls]
...
MODELS = [
    ...
    {"group": "olmo",   "id": "allenai/OLMo-2-0425-1B",  "n_layers": 16,  "large_gpu": False, "shard_pairs": 500000, "batch_size": 512},
