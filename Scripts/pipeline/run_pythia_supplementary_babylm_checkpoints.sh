...
#
# Usage:
#   bash Scripts/pipeline/run_pythia_supplementary_babylm_checkpoints.sh
#   bash Scripts/pipeline/run_pythia_supplementary_babylm_checkpoints.sh --models 160m 1b
#   bash Scripts/pipeline/run_pythia_supplementary_babylm_checkpoints.sh --skip-controls
