...
Separate track, run on the server via `Scripts/supplementary/supplementary_analyses.sh`. Job list
is generated by `Scripts/supplementary/supplementary_jobs.py` from `Results/*/by_layer_mlp.csv`, so
